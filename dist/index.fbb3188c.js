...
_viewJs.UI_ELEMENTS.SETTINGS.addEventListener('click', function() {
    _viewJs.UI_ELEMENTS.MODAL.classList.add('modal-active');
    _viewJs.UI_ELEMENTS.MODAL_SETTINGS.classList.add('modal-active');
});
_viewJs.UI_ELEMENTS.AUTHORIZATION.addEventListener('click', function() {
    _viewJs.UI_ELEMENTS.MODAL.classList.add('modal-active');
    _viewJs.UI_ELEMENTS.MODAL_AUTHORIZATION.classList.add('modal-active');
});
_viewJs.UI_ELEMENTS.CODE.addEventListener('click', function() {
    _viewJs.UI_ELEMENTS.MODAL.classList.add('modal-active');
    _viewJs.UI_ELEMENTS.MODAL_CODE.classList.add('modal-active');
});
_viewJs.UI_ELEMENTS.BUTTON_CLOSE.forEach((item)=>{
    item.addEventListener('click', function() {
        _viewJs.UI_ELEMENTS.MODAL.classList.remove('modal-active');
        _viewJs.UI_ELEMENTS.MODAL_SETTINGS.classList.remove('modal-active');
        _viewJs.UI_ELEMENTS.MODAL_AUTHORIZATION.classList.remove('modal-active');
        _viewJs.UI_ELEMENTS.MODAL_CODE.classList.remove('modal-active');
    });
});
_viewJs.UI_ELEMENTS.BUTTON_CODE.addEventListener('click', _authorization.getCode);
_viewJs.UI_ELEMENTS.BUTTON_SEND_MESSAGE.addEventListener('click', createMessage);
function createMessage() {
    event.preventDefault();
    let message = _viewJs.UI_ELEMENTS.INPUT_MESSAGE.value;
    if (message) {
        const element = document.createElement('div');
        element.className = 'message__wrapper';
        element.append(_viewJs.UI_ELEMENTS.MESSAGE.content.cloneNode(true));
        ...
        _viewJs.UI_ELEMENTS.CHAT.append(element);
        _viewJs.UI_ELEMENTS.INPUT_MESSAGE.value = '';
    }
}

},{"./view.js":"2GA9o","date-fns":"9yHCA","./authorization":"iH89i"}],"2GA9o":[function(require,module,exports) {
...
const UI_ELEMENTS = {
    ...
    BUTTON_CLOSE: document.querySelectorAll('.modal__close'),
    MODAL: document.querySelector('.modal'),
    MODAL_SETTINGS: document.querySelector('.modal-settings'),
    MODAL_AUTHORIZATION: document.querySelector('.modal-authorization'),
    MODAL_CODE: document.querySelector('.modal-code'),
    TIME: document.querySelector('.message__time'),
    MESSAGE: document.querySelector('.message'),
    BUTTON_SEND_MESSAGE: document.querySelector('.form__send-message'),
    INPUT_MESSAGE: document.querySelector('.form__message'),
    MESSAGE_TEXT: document.querySelector('.message__text'),
    TEMPLATE_MESSAGE: document.querySelector('.message'),
    CHAT: document.querySelector('.chat__wrapper'),
    AUTHORIZATION: document.querySelector('.header__authorization'),
    CODE: document.querySelector('.header__code'),
    BUTTON_CODE: document.querySelector('.modal-authorization__send'),
    INPUT_AUTHORIZATION: document.querySelector('.modal-authorization__input')
};
...
async function getCode() {
    event.preventDefault();
    try {
        const email = _view.UI_ELEMENTS.INPUT_AUTHORIZATION.value;
        const response = await _axiosDefault.default.post('https://mighty-cove-31255.herokuapp.com/api/user', {
            email: String(email)
        });
        if (response.data.success) console.log('Все ок');
    } catch (error) {
        console.log('Что то пошло не так');
    }
}

},{"./view":"2GA9o","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}]},["huMbS","bDbGG"], "bDbGG", "parcelRequire25d8")
