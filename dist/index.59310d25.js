...
function init() {
    ...
    //   }
    // })
    _uielements.UI_ELEMENTS.CHAT.addEventListener('scroll', _api.pagination);
...
async function getCode() {
    ...
    try {
        ...
        if (response.status === 200) {
            ...
            _main.closeModal();
            _main.showModal(_uielements.UI_ELEMENTS.MODALS.AUTHORIZATION);
        }
    } catch (error) {
...
function getLastMessages(messages) {
    ...
    const stepSlice = 15;
    for(let i = 0; i < messages.length; i += stepSlice)lastMessages.push(messages.slice(i, i + stepSlice));
...
function pagination() {
    let scrollWidth = _uielements.UI_ELEMENTS.CHAT.scrollTop - _uielements.UI_ELEMENTS.CHAT.offsetHeight;
    console.log(lastMessages);
    if (_uielements.UI_ELEMENTS.CHAT.scrollHeight + scrollWidth <= 0) lastMessages.pop().forEach((message)=>{
        console.log(message);
        _message.createMessage(message._id, message.user.name, message.text, message.createdAt);
    });
    else if (lastMessages.length === 0) console.log('VSE');
}
const options = {
    reconnectInterval: 1000
};
const WEBSOCKET = new _reconnectingWebsocketDefault.default(`wss://mighty-cove-31255.herokuapp.com/websockets?${_jsCookieDefault.default.get('authorization_token')}`, [], options);
...
async function sendMessage() {
    ...
    _main.bottomToScroll();
}

},{"axios":"jo6P5","./constants":"1j8D1","./cookie":"iflT4","js-cookie":"c8bBu","./showserverresponse":"1XFq7","./message":"lGCpb","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./uielements":"eAreM","./main":"bDbGG","reconnecting-websocket":"foTU5"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}],"1j8D1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
// const TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InBhdmx1Y2hlbmtvOTYub3JnQG1haWwucnUiLCJpYXQiOjE2NTIzNzUwNjMsImV4cCI6MTY1MjgyMTQ2M30.X1TGIfAZ6RW07h9eq5B9qouWxcziDD_fQE16C7RjJgI'
...
function createMessage(id, name, text, time) {
    ...
    if (message) {
        ...
        _uielements.UI_ELEMENTS.CHAT_WRAPPER.append(element);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bDbGG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "bottomToScroll", ()=>bottomToScroll
...
function bottomToScroll() {
    _uielements.UI_ELEMENTS.CHAT.scrollTo(0, 0);
}

},{"./uielements":"eAreM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"foTU5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*! *****************************************************************************
